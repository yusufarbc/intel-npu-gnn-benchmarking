...
class: text-left compact-slide overflow-hidden
highlighter: shiki
drawings:
  persist: false
transition: fade
...
<div class="glass-panel !m-0 p-2.5 border-l-4 border-l-blue-600 bg-slate-50/70">
<div class="text-[11px] font-bold uppercase tracking-wider text-blue-800 mb-1 flex items-center gap-1.5">
<span>🎯 Research Questions</span>
</div>
<div class="text-[12.5px] font-semibold text-slate-800 leading-snug">
When does a client NPU provide real end-to-end acceleration for GNN inference compared with the CPU and integrated GPU?
</div>
<div class="text-[11.5px] text-slate-600 leading-snug mt-1.5 pt-1.5 border-t border-slate-200/80">
Does INT8 quantization consistently improve NPU performance?
</div>
</div>
<div class="text-[10.5px] text-slate-600 font-medium bg-slate-100/90 border border-slate-200/90 rounded px-2.5 py-1 flex items-center justify-between">
<span>🔬 <strong>Experimental Scope:</strong> 14 models · 3 backends</span>
<span class="text-slate-500">OpenVINO 2024.1 · Batch 1</span>
</div>
<div class="glass-panel !m-0 p-2.5 border-2 border-blue-500/80 bg-blue-50/40 rounded-lg flex flex-col justify-between">
<div>
<div class="text-[11px] font-bold uppercase tracking-wider text-blue-900 mb-1 flex items-center gap-1.5">
<span>💡 Central Finding</span>
</div>
<div class="text-[14px] font-extrabold text-slate-900 leading-snug">
Best accelerator depends on the workload.
</div>
<div class="text-[11px] text-slate-700 leading-relaxed mt-1">
...
<div class="text-[10.5px] font-semibold text-rose-800 bg-rose-50 border border-rose-200 rounded px-2 py-0.5 mt-1.5">
⚠️ INT8 is not a guaranteed speedup and must be validated per model.
</div>
</div>
</div>
<div class="col-span-6 flex flex-col justify-between gap-1.5">
<div class="glass-panel !m-0 p-2 border-l-4 border-l-emerald-600">
<div class="flex items-center gap-1.5 text-[11px] font-bold text-emerald-800">
<span>⚡ Dense FP32 Models</span>
<span class="stat-badge badge-npu text-[9px] py-0 px-1">NPU Excels</span>
</div>
...
<div class="glass-panel !m-0 p-2 border-l-4 border-l-blue-600">
<div class="flex items-center gap-1.5 text-[11px] font-bold text-blue-800">
<span>🌐 Evaluated GNN Workloads</span>
<span class="stat-badge badge-igpu text-[9px] py-0 px-1">iGPU Leads</span>
</div>
<div class="text-[11px] text-slate-700 leading-snug mt-0.5">
...
<div class="glass-panel !m-0 p-2 border-l-4 border-l-rose-600">
<div class="flex items-center gap-1.5 text-[11px] font-bold text-rose-800">
<span>⚠️ INT8 Quantization</span>
<span class="stat-badge badge-cpu text-[9px] py-0 px-1">Not Always Faster</span>
</div>
<div class="text-[11px] text-slate-700 leading-snug mt-0.5">
...
<div class="flex justify-between items-center text-[10px] text-slate-400 border-t border-slate-100 pt-0.5">
<span>💡 Press <kbd>Right Arrow</kbd> for deep-dive slides (Setup, Irregular Memory Mismatch, FP32 Latency, INT8 Analysis, Decision Guide)</span>
