...
\begin{figure}[htbp]
    ...
    \caption{APPNP FP32 latency scaling on NPU at a fixed density of 7 edges/node. Error bars show run-to-run standard deviation; each point represents a separately compiled fixed-shape graph.}
    \label{fig:fig6}
\end{figure}
