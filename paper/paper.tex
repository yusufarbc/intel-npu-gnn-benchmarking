...
The authors used AI-based tools to assist with English language editing and minor implementation details. These tools were used solely for linguistic refinement and limited implementation support. They did not contribute to the scientific ideas, experimental design, results, or conclusions of this work, which were developed entirely by the authors.
