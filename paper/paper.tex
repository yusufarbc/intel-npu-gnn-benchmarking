...
\begin{figure}[htbp]
    ...
    \caption{ORT optimization speedup by device. The iGPU shows larger gains from graph-level optimization for GNNs; NPU optimization returns are uniformly modest.}
    \label{fig:fig5a}
\end{figure}
...
The authors disclose the use of Anthropic Claude 3.5 Sonnet and OpenAI ChatGPT GPT-4o during preparation of this manuscript. Claude 3.5 Sonnet and ChatGPT GPT-4o assisted with initial code scaffolding for the evaluation scripts described in Section~III and with language editing in Sections~I, II, IV, and~V. OpenAI Codex (GPT-5) assisted with a revision draft addressing reviewer comments in Sections~I--V, including terminology, methodological clarification, figure captions, and presentation. The authors subsequently reviewed and revised all AI-assisted material. No AI system generated experimental data, numerical results, or figures. All research questions, experimental design, measurements on physical hardware, results, interpretations, and conclusions are the authors' work, and the authors take responsibility for the complete manuscript.
